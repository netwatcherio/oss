...
import {strlen, isBlank, partitionString} from "@/lib/ascii-table3/printable-characters";
...
export class AsciiTable3 {
     ...
     */
     static padStart(str, maxLength, fillStr = ' ') {
        if (strlen(str) >= maxLength) {
            ...
            // partition string
            const partArray = partitionString(str);
    ...
    static wordWrap(str, maxWidth) {
        // partition string
        const partArray = partitionString(String(str));
    ...
    static truncateString(str, maxSize) {
        ...
        if (strlen(str) > maxSize) {
            ...
            for (const [nonPrintable, printable] of partitionString(str)) {
