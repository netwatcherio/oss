...
<template>
  ...
  <Title title="edit member" :subtitle="`edit a member of the site '${state.site.name}'`" :history="[{title: 'workspaces', link: '/workspaces'}, {title: state.site.name, link: `/workspaces/${state.site.id}`}, {title: `members`, link: `/workspaces/${state.site.id}/members`}]"></Title>
    <div class="row">
      <div class="col-12">
        <div class="card">
