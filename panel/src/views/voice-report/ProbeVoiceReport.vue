...
// panel/src/views/voice-report/ProbeVoiceReport.vue
//
// Per-probe live voice report view.

import { onMounted, ref } from 'vue'
import { useRoute } from 'vue-router'
import { ProbeService } from '@/services/apiService'
...
const probeId = ref<number | string>('')

onMounted(async () => {
  probeId.value = String(route.params.pID ?? '')
  try {
    data.value = await ProbeService.fetchProbeReportData(probeId.value, 7)
  } catch (e: any) {
