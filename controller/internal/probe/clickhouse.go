...
type TrafficSimPayload struct {
	...
	OutOfOrderPct          float64 `json:"outOfOrderPercent,omitempty"`
	Duplicates             uint64  `json:"duplicates"`
	DuplicatePct           float64 `json:"duplicatePercent,omitempty"`
	MosScore               float64 `json:"mos,omitempty"`
	...
	MaxConsecutiveLoss     uint64  `json:"maxConsecutiveLoss,omitempty"`
	TotalBursts            uint64  `json:"totalBursts,omitempty"`
